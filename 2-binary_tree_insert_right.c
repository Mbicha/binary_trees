...
/**
 * binary_tree_node_right - creates a binary tree node
 * @parent: parnt of the node to create
 * @value: value to store in new node
 *
 * Return: pointer to the new node
 */
binary_tree_t *binary_tree_node_right(binary_tree_t *parent, int value)
{
...
binary_tree_t *binary_tree_insert_right(binary_tree_t *parent, int value)
{
	...
	if (parent == NULL)
		return (NULL);
	right_child = binary_tree_node_right(parent, value);
	if (right_child == NULL)
		return (NULL);
